...
class Uploader extends EventEmitter
  # Constructor
  constructor: ({accessKey, secretKey, sessionToken, region, endpoint, stream, objectName, objectParams, bucket, partSize, maxBufferSize, waitForPartAttempts, waitTime, debug}, @cb) ->
    super()
    aws.config.update
